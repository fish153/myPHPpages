...
function LogInForm()
{
	...
	while ( $row = mysql_fetch_row($result)) {
		...
		if($level == '0')
		{
			$credent ="Add a new employee, view";	
		}
		if($level == 1)
		{
		...
		if($level == 2)
		{
			$credent = "View table, Listen Twin Peaks theme";
		}
		print "
			<tr>
				<td>
...
";
	...
	if($_SESSION['level'] == 2)
	{
		...
		<div class='topTable'>
			<audio controls>
				<source src='http://upload.wikimedia.org/wikipedia/en/b/b7/Twin_Peaks_Theme.ogg' type='audio/ogg'>
			</audio>
		</div>
	";
	}
