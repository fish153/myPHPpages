...
else
{
	...
	else
	{
		...
		if(isset($_GET['delete']) and $_GET['delete'] == 'yes')
		{
			...
			{
				print "<p>You do not have enougth credentials to delete any records in the table<p>";
			}
		...
		if(isset($_GET['edit'])) // check if edit link clicked
		{
			...
			if($_SESSION['level'] == 1)
			{
				...
				$fname1 = html_entity_decode($fname1,  ENT_QUOTES);
			       	$lname1 = html_entity_decode($lname1, ENT_QUOTES);	
				
				editform($employee, $fname1, $lname1, $email1, $zip1); // show edit form				
			}
			else
			{
				print "<p>You do not have enougth credentials to edit any records in the table<p>";
			}
		...
		if(isset($new)) // check if 'New employee' button is pressed
		{
			...
			{
				print "<p>You do not have enougth credentials to add new employees<p>";
			}
		...
		if(!empty($add)) // check if 'Add employee' of the form is pressed
		{
			...
			{
				print "<p>You do not have enougth credentials to add employees<p>";
			}
